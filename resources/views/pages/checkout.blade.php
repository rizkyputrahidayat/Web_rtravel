        ...
        <div class="row">
            <div class="col-lg-8 pl-lg-0">
                <div class="card card-details">
                    ...
                    <div class="attende">
                        <table class="table table-responsive-sm text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    {{-- <td><img src="frontend/images/logoo.png" height="50px"></td> --}}
                                    <td><img src="https://ui-avatars.com/api/?name={{$detail->username}}" 
                                        class="rounded-circle" height="50px"></td>
                                    ...
                                    <td class="align-middle"><a href="{{ route('checkout-remove', $detail->id) }}">
                                            <img src="{{ url('frontend/images/ic_remove.png')}}"></a></td>
                                </tr>
                                @empty
                                    <tr>
                    ...
                    <p class="disclaimer mb-0">You are only able to invite member that has registered in RTRAVEL</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="card card-details card-right">
                    ...
                    <p class="payment-instruction">
                        Please complete the payment before you <br>
                        continue the wonderful the trip
                    </p>
                    <div class="bank">
                        <div class="bank-item pb-3">
                            <img class="bank-image" src="frontend/images/ic_bank.png">
